package com.example.athaya.Home.pertemuan_10

import android.os.Bundle
import androidx.appcompat.app.AppCompatActivity
import androidx.core.content.ContextCompat
import com.example.athaya.R
import com.example.athaya.databinding.ActivityTenthBinding
        ...
        TabLayoutMediator(binding.tabLayout, binding.viewPager) { tab, position ->
            when (position) {
                0 -> {
                    ...
                    badge.backgroundColor = ContextCompat.getColor(this, R.color.rred_soft)
                }
                1 -> {
                    tab.text = "Tab B"
                    // Tambah Icon
